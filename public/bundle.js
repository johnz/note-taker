...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createElement(
	    ...
	    React.createElement(Route, { name: 'profile page', path: '/profile/:username', handler: Profile }),
	...
	var Home = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            "Search by Github usename above"
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        this.ref = new Firebase('https://note-taker-2015.firebaseio.com');
	        this.init();
	    },
	    componentWillUnmount: function componentWillUnmount() {
	        this.unbind('notes');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchGithub = React.createClass({
	    ...
	    handleSubmit: function handleSubmit() {
	        ...
	        this.transitionTo('profile page', { username: username });
	    },
	    render: function render() {
	        return React.createElement(
	            'div',
